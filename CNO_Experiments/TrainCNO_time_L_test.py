...
checkpoint_file = "/data/user_data/vhsingh/CNO_experiments/LDC_824/Intermediate-Complex/one/0.0/model0/epoch=227-step=223212.ckpt"
model = CNO_time.load_from_checkpoint(checkpoint_file)
