...
for epoch in range(1, epochs + 1):
    ...
    if (epoch-1) % 50 == 0:
        ...
        fig, ax = plt.subplots(4, 2, figsize=(14, 10))  # 2x2 grid for horizontal and vertical velocity
        channels = ["Density","Horizontal Velocity (u)", "Vertical Velocity (v)", "Pressure"]
        cmap = "gist_ncar"  # Colormap as per your previous setup

        for ch in range(4):  # Loop over horizontal and vertical velocity channels
