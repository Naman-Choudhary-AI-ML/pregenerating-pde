...
def get_dataset(dataset, **kwargs):
    ...
    **kwargs overwrite the default settings.
    ...
    if "fluids.incompressible.Gaussians.npz" in dataset:  # Your dataset identifier
        ...
        return GaussianNumpyDataset(
            ...
            resolution=kwargs.pop("resolution", 128),
            just_velocities=kwargs.pop("just_velocities", False),
            which=kwargs.pop("which"),  # Pass `which` parameter here
            **kwargs,
        )
