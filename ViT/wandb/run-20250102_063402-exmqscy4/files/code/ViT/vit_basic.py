...
patch_size = (4, 4)    # Size of patches
dim = 768               # Dimensionality of patch embeddings
depth = 16                # Number of transformer blocks
heads = 16                # Number of attention heads
dim_head = 48            # Dimensionality of each attention head
emb_dropout = 0.15
...
scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer, T_0=100, eta_min=10**-6)
...
for epoch in range(epochs):
    ...
    if epoch % freq_plot == 0 or epoch == epochs - 1 or epoch == 10:
