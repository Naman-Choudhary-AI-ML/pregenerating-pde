...
def main():
    ...
    original_geo_file = os.path.expanduser("~/Desktop/OpenFoam_Shapes/Square/Design_point_0/main.geo")
    original_0_folder = os.path.expanduser("~/Desktop/OpenFoam_Shapes/Square/Design_point_0/0")
    original_system_folder = os.path.expanduser("~/Desktop/OpenFoam_Shapes/Square/Design_point_0/system")
    original_physical_properties = os.path.expanduser("~/Desktop/OpenFoam_Shapes/Square/Design_point_0/physicalProperties")
    original_momentumTransport = os.path.expanduser("~/Desktop/OpenFoam_Shapes/Square/Design_point_0/constant/momentumTransport")
    
    # Define the base directory for design points
    base_dir = os.path.expanduser("~/Desktop/OpenFoam_Shapes/Square/design_points")
