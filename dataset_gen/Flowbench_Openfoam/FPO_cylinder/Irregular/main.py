...
def parse_internal_field(file_path, field_type="vector", expected_n_points=16320, default_value=None):
    """
...
def parse_simulation(sim_folder, expected_n_points=16320):
    """
...
def gather_all_simulations(sim_folders, expected_n_points=16320):
    """
...
def main():
    ...
    for folder in new_folders:
        ...
        update_Umax_in_simulation_folder(folder, min_value=1.125e-3, max_value=1.125e-2)
