...
def main():
    ...
    if fixed_params:
        ...
        random_coeffs = generate_random_coefficients(p=p)
    ...
    for i, folder in enumerate(new_folders, start=1):
        ...
        if not fixed_params:
            ...
            random_coeffs = generate_random_coefficients(p=p)
        generate_U_file(folder, i_c, j_c, hole_size=hole_size, coefficients=random_coeffs)         # This replaces the old generate_setfields.py call
