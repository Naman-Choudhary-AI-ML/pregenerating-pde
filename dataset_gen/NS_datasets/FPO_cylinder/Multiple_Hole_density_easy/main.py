...
def parse_simulation(sim_folder, Umax_simulation=None, L=2, nu=1.0e-3):
    """
...
def gather_all_simulations(sim_folders, grid_shape=(128, 128), c_file_name="0/C", L=2, nu=1.0e-3):
    """
...
def update_Umax_in_simulation_folder(sim_folder, re_value, L=2, nu=1.0e-3):
    """
...
nu = 1.0e-3     # kinematic viscosity [m²/s]
