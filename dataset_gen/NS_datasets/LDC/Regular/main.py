...
def gather_all_simulations(sim_folders, grid_shape=(128, 128), c_file_name="0/C", L=2, nu=1.53e-5):
    ...
    for folder in sim_folders:
        ...
        sim_result = parse_simulation(folder, expected_n_points=16384, Umax_simulation=Umax_simulation, L=L, nu=nu)
...
def main(batch_name: str, total_trajectories: int):
    save_dir = f"/data/user_data/vhsingh/LDC_Regular/{batch_name}"
