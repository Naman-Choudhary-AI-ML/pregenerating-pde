...
def generate_normal_re_values(num_samples, mean=500, std_dev=2000, min_re=8000, max_re=10000):
    """
...
def main(batch_name: str, total_trajectories: int):
    ...
    re_values = generate_normal_re_values(total_trajectories, mean=9000, std_dev=400)
