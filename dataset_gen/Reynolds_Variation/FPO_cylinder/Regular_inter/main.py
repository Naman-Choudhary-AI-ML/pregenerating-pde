...
def generate_normal_re_values(num_samples, mean=5000, std_dev=2000, min_re=2000, max_re=4000):
    """
...
def main(batch_name: str, total_trajectories: int):
    ...
    re_values = generate_normal_re_values(total_trajectories, mean=3000, std_dev=200)
